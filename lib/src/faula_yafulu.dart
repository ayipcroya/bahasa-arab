...
class faula_yafulu extends StatefulWidget {
  @override
  _faula_yafuluState createState() => _faula_yafuluState();
}

class _faula_yafuluState extends State<faula_yafulu> {
  String _kata;
  String fiilmadi = 'فَعَلَ';
  String fiilmadihuma = 'فَعَلَا';
  String fiilmadihum = 'فَعَلُواْ';
  String fiilmadihia = 'فَعَلَتْ';
  String fiilmadihumapr = 'فَعُلَتَا';
  String fiilmadihunna ='فَعُلْنَ';
  String fiilmadianta = 'فَعُلْتَ';
  String fiilmadiantuma ='فَعُلْتُمَا';
  String fiilmadiantum = 'فَعُلْتُمْ';
  String fiilmadianti ='فَعُلْتِ';
  String fiilmadiantunna = 'فَعُلْتُنَّ';
  String fiilmadiana = 'فَعُلْتُ';
  String fiilmadinahnu = 'فَعُلْنَا';


  String fiilmudore = 'يَفْعُلُ';
  String fiilmudorehuma = 'يَفْعُلَانِ';
  String fiilmudorehum = 'يَفْعُلُوْنَ';
  String fiilmudorehia = 'تَفْعُلُ';
  String fiilmudorehumapr = 'تَفْعُلَانِ';
  String fiilmudorehunna = 'يَفْعُلْنَ';
  String fiilmudoreanta = 'تَفْعُلُ';
  String fiilmudoreantum = 'تَفْعُلُوْنَ';
  String fiilmudoreanti = 'تَفْعُلِيْنَ';
  String fiilmudoreantunna = 'تَفْعُلْنَ';
  String fiilmudoreana = 'اَفْعُلُ';
  String fiilmudorenahnu = 'نَفْعُلُ';

  String masdar = 'فَعْلاً';
  String masdarhuma = 'فَعْلَانِ';
  String masdarhum = 'فَعْلَاتٍ';

  String fiilamr = 'اُفْعُلْ';
  String fiilamrantuma = 'اُفْعُلَا';
  String fiilamrantum = 'اُفْعِلُوا';
  String fiilamranti = 'اُفْعُلِي';
  String fiilamrantunna = 'اُفْعُلْنَ';
  ...
  void _submit (){
    setState(() {
      ...
      fiilmadi = '${_kata.substring(0,1)}ُ${_kata.substring(1,2)}َ${_kata.substring(2,3)}َ' ;
      fiilmadihuma = '${_kata.substring(0,1)}ُ${_kata.substring(1,2)}َ${_kata.substring(2,3)}َا';
      fiilmadihum = '${_kata.substring(0,1)}ُ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ُوْا';
      fiilmadihia = '${_kata.substring(0,1)}ُ${_kata.substring(1,2)}َ${_kata.substring(2,3)}َتْ';
      fiilmadihumapr ='${_kata.substring(0,1)}ُ${_kata.substring(1,2)}َ${_kata.substring(2,3)}َتَا';
      fiilmadihunna = '${_kata.substring(0,1)}ُ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْنَ';
      fiilmadianta = '${_kata.substring(0,1)}ُ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْتَ';
      fiilmadiantuma ='${_kata.substring(0,1)}ُ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْتُمَا';
      fiilmadiantum = '${_kata.substring(0,1)}ُ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْتُمْ';
      fiilmadianti ='${_kata.substring(0,1)}ُ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْتِ';
      fiilmadiantunna = '${_kata.substring(0,1)}ُ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْتُنَّ';
      fiilmadiana ='${_kata.substring(0,1)}ُ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْتُ';
      fiilmadinahnu = '${_kata.substring(0,1)}ُ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْنَا';

      fiilmudore = 'يَ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}ُ';
      fiilmudorehuma = 'يَ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}َانِ';
      fiilmudorehum = 'يَ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}ُونَ';
      fiilmudorehia = 'تَ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}ُ';
      fiilmudorehumapr = 'تَ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}َانِ';
      fiilmudorehunna = 'يَ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}ْنَ';
      fiilmudoreanta = 'تَ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}ُ';
      fiilmudoreantum = 'تَ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}ُوْنَ';
      fiilmudoreanti = 'تَ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}ِيْنَ';
      fiilmudoreantunna = 'تَ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}ْنَ';
      fiilmudoreana = 'اَ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}ُ';
      fiilmudorenahnu = 'نَ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}ُ';
      ...
      fiilamr = 'اُ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}ْ';
      fiilamrantuma = 'اُ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}َا';
      fiilamrantum = 'اُ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}ُوا';
      fiilamranti = 'اً${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}ِي';
      fiilamrantunna = 'اُ${_kata.substring(0,1)}ْ${_kata.substring(1,2)}ُ${_kata.substring(2,3)}ْنَ';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title: Text('فَعُلَ يَفْعُلُ', style: TextStyle(fontSize: 20.0),),
      ) ,
