...
class faala_yafulu extends StatefulWidget {
  @override
  _faala_yafuluState createState() => _faala_yafuluState();
}

class _faala_yafuluState extends State<faala_yafulu> {
  ...
  String fiilmadihumapr = 'فَعَلَتَا';
  String fiilmadihunna ='فَعَلْنَ';
  String fiilmadianta = 'فَعَلْتَ';
  String fiilmadiantuma ='فَعَلْتُمَا';
  String fiilmadiantum = 'فَعَلْتُمْ';
  String fiilmadianti ='فَعَلْتِ';
  String fiilmadiantunna = 'فَعَلْتُنَّ';
  String fiilmadiana = 'فَعَلْتُ';
  String fiilmadinahnu = 'فَعَلْنَا';
  ...
  void _submit (){
    setState(() {
      ...
      fiilmadi = '${_kata.substring(0,1)}َ${_kata.substring(1,2)}َ${_kata.substring(2,3)}َ' ;
      fiilmadihuma = '${_kata.substring(0,1)}َ${_kata.substring(1,2)}َ${_kata.substring(2,3)}َا';
      fiilmadihum = '${_kata.substring(0,1)}َ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ُوْا';
      fiilmadihia = '${_kata.substring(0,1)}َ${_kata.substring(1,2)}َ${_kata.substring(2,3)}َتْ';
      fiilmadihumapr ='${_kata.substring(0,1)}َ${_kata.substring(1,2)}َ${_kata.substring(2,3)}َتَا';
      fiilmadihunna = '${_kata.substring(0,1)}َ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْنَ';
      fiilmadianta = '${_kata.substring(0,1)}َ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْتَ';
      fiilmadiantuma ='${_kata.substring(0,1)}َ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْتُمَا';
      fiilmadiantum = '${_kata.substring(0,1)}َ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْتُمْ';
      fiilmadianti ='${_kata.substring(0,1)}َ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْتِ';
      fiilmadiantunna = '${_kata.substring(0,1)}َ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْتُنَّ';
      fiilmadiana ='${_kata.substring(0,1)}َ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْتُ';
      fiilmadinahnu = '${_kata.substring(0,1)}َ${_kata.substring(1,2)}َ${_kata.substring(2,3)}ْنَا';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title: Text('فَعَلَ يَفْعُلُ', style: TextStyle(fontSize: 20.0),),
      ) ,
