...
class faila_yafilu extends StatefulWidget {
  @override
  _faila_yafiluState createState() => _faila_yafiluState();
}

class _faila_yafiluState extends State<faila_yafilu> {
  String _kata;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title: Text('فَعِلَ يَفْعِلُ', style: TextStyle(fontSize: 20.0),),
      ) ,
